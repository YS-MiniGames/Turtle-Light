...
for x in np.arange(-100,100,s):
    lens=Edge(line=Line(Dot(x,400+(math.sqrt(x**2+1000)-math.sqrt(1000)-(math.sqrt(11000)-math.sqrt(1000)))),Dot(x+s,400+(math.sqrt((x+s)**2+1000)-math.sqrt(1000)-(math.sqrt(11000)-math.sqrt(1000)))),False,False,(0,255,255),2),
                refraction=1.2)
    lenses.append(lens)
